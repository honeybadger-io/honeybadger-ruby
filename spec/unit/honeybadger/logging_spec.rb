...
RSpec.describe Honeybadger::Logging::Base do
...
RSpec.describe Honeybadger::Logging::StandardLogger do
...
RSpec.describe Honeybadger::Logging::BootLogger.instance do
  LOG_SEVERITIES.each do |severity|
    it { should respond_to severity }
...
RSpec.describe Honeybadger::Logging::FormattedLogger do
...
RSpec.describe Honeybadger::Logging::ConfigLogger do
